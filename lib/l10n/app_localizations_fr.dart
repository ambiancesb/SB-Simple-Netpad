...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get shellShowNotesPanel => 'Afficher le panneau de notes (Ctrl+N)';

  @override
  String get shellHidePeersPanel => 'Masquer le panneau des pairs';

  @override
  String get shellShowPeersPanel => 'Afficher le panneau des pairs (Ctrl+P)';

  @override
  String shellPeersTooltipConnected(int count, String action) {
    return '$count sessions de pairs chiffrées · $action le panneau des pairs (Ctrl+P)';
  }
  ...
  @override
  String get shellFindInNote => 'Rechercher dans la note (Ctrl+F)';
  ...
  @override
  String get editorShowReplace => 'Afficher le remplacement (Ctrl+H)';

  @override
  String get editorHideReplace => 'Masquer le remplacement (Ctrl+H)';
  ...
  String get peersNoTrustedDevices =>
      'Aucun appareil de confiance — associez une fois pour activer la synchronisation automatique';
  ...
  String get peersNoDiscoveredPeers =>
      'Aucun pair découvert — Linux doit être sur le même sous-réseau Wi‑Fi que Cet appareil (vérifiez l\'adresse ci-dessus), ou utilisez Connecter par IP';
  ...
  String peersResolveFailedSnack(String peer) {
    return 'Impossible de résoudre $peer. Vérifiez Avahi et le même sous-réseau, ou utilisez Connecter par IP.';
  }
  ...
  String get settingsDeviceHint =>
      'Le nom de l\'appareil et la salle nécessitent Enregistrer (Ctrl+S). Les préférences d\'apparence et d\'éditeur s\'enregistrent immédiatement.';
  ...
  @override
  String get settingsProUnlocked => 'Pro débloqué';
  ...
  @override
  String get settingsNoPreviousPro => 'Aucun achat Pro précédent trouvé';
  ...
  @override
  String get settingsEulaSubtitlePro => 'Pro · Ouvre l\'EULA sur GitHub Pages';
  ...
  @override
  String get paywallTitle => 'Débloquer Netpad Pro';
  ...
  String get paywallPurchasesUnsupported =>
      'Les achats intégrés ne sont pas disponibles sur cette plateforme. Installez depuis l\'App Store, Google Play ou Microsoft Store pour débloquer Pro.';

  @override
  String get paywallBuyPro => 'Acheter Pro';

  @override
  String paywallBuyProPrice(String price) {
    return 'Acheter Pro · $price';
  }
  ...
  @override
  String get paywallProRestored => 'Pro restauré';

  @override
  String get paywallNoPreviousPro => 'Aucun achat Pro précédent trouvé';

  @override
  String proHighlightNoteLimit(int limit) {
    return 'La version gratuite inclut jusqu\'à $limit notes. Débloquez Pro pour des notes illimitées.';
  }

  @override
  String proHighlightPeerLimit(int limit) {
    return 'La version gratuite inclut jusqu\'à $limit pairs connectés. Débloquez Pro pour des pairs illimités.';
  }

  @override
  String get proHighlightVersionHistory =>
      'L\'historique des versions est une fonctionnalité Pro.';

  @override
  String get proHighlightVoice =>
      'La dictée vocale est une fonctionnalité Pro.';

  @override
  String get proHighlightAutoSync =>
      'La synchronisation automatique des pairs de confiance est une fonctionnalité Pro.';

  @override
  String get proHighlightSkins =>
      'Les thèmes supplémentaires sont inclus avec Pro.';
  ...
  String get helpPeers4 =>
      'Après le premier Accepter, les appareils de confiance peuvent se reconnecter automatiquement.';
  ...
  String get helpFileSharing2 =>
      'Enregistrer dans un fichier exporte la note active en .txt ou .md.';
  ...
  String get helpFileSharing4 =>
      'Partager utilise la feuille de partage du système ; Linux bascule sur le presse-papiers.';
  ...
  @override
  String get helpDesktopShortcuts4 => 'Ctrl/Cmd+H — Rechercher et remplacer';
  ...
  @override
  String get helpDesktopShortcuts7 => 'Ctrl/Cmd+Q — Quitter (Windows/Linux)';
  ...
  String get helpTroubleshooting4 =>
      'Linux : installez dbus et avahi-daemon si la découverte ne démarre jamais.';
  ...
  String aboutEulaBody(int noteLimit, int peerLimit) {
    return 'SB Simple Netpad est sous licence EULA, pas une licence open source. L\'édition principale et la synchronisation LAN sont gratuites (jusqu\'à $noteLimit notes et $peerLimit pairs connectés). Netpad Pro est un déblocage unique via l\'App Store, Google Play ou Microsoft Store.';
  }
