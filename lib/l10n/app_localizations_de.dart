...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String shellShowNotesPanel(String mod) {
    return 'Notizenbereich anzeigen ($mod+N)';
  }
  ...
  String shellShowPeersPanel(String mod) {
    return 'Peer-Bereich anzeigen ($mod+P)';
  }

  @override
  String shellPeersTooltipConnected(int count, String action, String mod) {
    return '$count verschlüsselte Peer-Sitzungen · Peer-Bereich $action ($mod+P)';
  }
  ...
  String editorShowReplace(String shortcut) {
    return 'Ersetzen anzeigen ($shortcut)';
  }

  @override
  String editorHideReplace(String shortcut) {
    return 'Ersetzen ausblenden ($shortcut)';
  }
  ...
  @override
  String get peersScanQr => 'QR-Code scannen';

  @override
  String get peersShowQrTooltip => 'QR-Code anzeigen';
  ...
  @override
  String get qrShowTitle => 'Per QR verbinden';

  @override
  String get qrShowBody =>
      'Lassen Sie ein anderes Gerät im selben WLAN diesen Code scannen, um zu verbinden.';

  @override
  String get qrShowNotReady => 'Warte auf lokale Adresse…';
  ...
  String get qrScanBody =>
      'Richten Sie die Kamera auf einen Netpad-QR-Code oder wählen Sie ein Foto.';

  @override
  String get qrScanCameraUnavailable =>
      'Kamera nicht verfügbar — wählen Sie ein Foto des QR-Codes.';

  @override
  String get qrScanPickImage => 'Foto wählen';

  @override
  String get qrScanInvalid => 'Kein gültiger Netpad-Verbindungscode';
  ...
  String settingsDeviceHint(String mod) {
    return 'Gerätename und Raum erfordern Speichern ($mod+S). Darstellungs- und Editoreinstellungen werden sofort gespeichert.';
  }
  ...
  String get settingsStandardStoreSubtitle =>
      'Holen Sie sich Standard über den App Store, Google Play oder Microsoft Store';
  ...
  @override
  String get paywallBenefitUnlimitedLength => 'Unbegrenzte Notizlänge';
  ...
  String get paywallPurchasesUnsupported =>
      'In-App-Käufe sind auf dieser Plattform nicht verfügbar. Öffnen Sie einen Store-Eintrag, um Standard freizuschalten.';
  ...
  @override
  String get paywallGetFromStore => 'Standard im Store holen';

  @override
  String get paywallOpenAppStore => 'App Store öffnen';

  @override
  String get paywallOpenPlayStore => 'Google Play öffnen';

  @override
  String get paywallOpenMicrosoftStore => 'Microsoft Store öffnen';

  @override
  String get paywallCouldNotOpenStore =>
      'Store-Eintrag konnte nicht geöffnet werden';
  ...
  @override
  String get freeTierUsageTitle => 'Free-Plan-Nutzung';
  ...
  String freeTierUsageLine(
    ...
    return 'Sync-Notizen $synced/$syncedLimit · Peers $peers/$peerLimit · Diese Notiz $chars/$charLimit';
  }
  ...
  String standardHighlightCharLimit(int limit) {
    return 'Free-Notizen sind auf $limit Zeichen begrenzt. Mit Standard unbegrenzt.';
  }
