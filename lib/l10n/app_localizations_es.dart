...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get peersNoDiscoveredPeers =>
      'Sin pares descubiertos — los dispositivos deben estar en la misma subred Wi‑Fi que Este dispositivo (verifica la dirección arriba), o usa Conectar por IP';
  ...
  String peersResolveFailedSnack(String peer) {
    return 'No se pudo resolver $peer. Verifica que estén en la misma subred, o usa Conectar por IP.';
  }
  ...
  @override
  String get qrShowTitle => 'Conectar con QR';

  @override
  String get qrShowBody =>
      'Haz que otro dispositivo en la misma Wi‑Fi escanee este código para conectar.';

  @override
  String get qrShowNotReady => 'Esperando una dirección local…';
  ...
  String get qrScanBody =>
      'Apunta la cámara a un código QR de Netpad, o elige una foto.';

  @override
  String get qrScanCameraUnavailable =>
      'Cámara no disponible — elige una foto del código QR.';

  @override
  String get qrScanPickImage => 'Elegir foto';

  @override
  String get qrScanInvalid => 'No es un código de conexión de Netpad válido';
  ...
  @override
  String get paywallBenefitUnlimitedLength => 'Longitud de nota ilimitada';
  ...
  @override
  String get freeTierUsageTitle => 'Uso del plan gratuito';
  ...
  String freeTierUsageLine(
    ...
    return 'Notas sincronizadas $synced/$syncedLimit · Peers $peers/$peerLimit · Esta nota $chars/$charLimit';
  }
  ...
  String standardHighlightCharLimit(int limit) {
    return 'Las notas gratis están limitadas a $limit caracteres. Desbloquea Standard para longitud ilimitada.';
  }
  ...
  String get helpFileSharing4 =>
      'Compartir usa la hoja de compartir del SO cuando está disponible; de lo contrario, la nota se copia al portapapeles.';
  ...
  String get helpTroubleshooting4 =>
      'Asegúrate de que todos los dispositivos estén en la misma subred Wi‑Fi y de que la red local / el firewall permitan el descubrimiento.';
  ...
  @override
  String get aboutStatus => 'Apto para uso LAN diario.';
